  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.nav}>
        <Text style={styles.navLink} onPress={() => console.log('Início clicado')}>Início</Text>
        <Text style={styles.navLink} onPress={() => console.log('Sobre clicado')}>Sobre</Text>
        <Text style={styles.navLink} onPress={() => console.log('Contato clicado')}>Contato</Text>
      </View>
